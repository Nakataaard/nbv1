...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 • sellemas
 • selldiamond`)
		  but = [{ buttonId: `.allmenu`, buttonText: { displayText: 'Back To Menu' }, type: 1 }]
        ...
        //+++ || FAKE TROLI         
        const troli =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2022, status: 200, thumbnail: tamnel, surface: 200, message: `*NAHBOTZ*`, orderTitle: 'Nakata', sellerJid: '0@s.whatsapp.net'} } }    
...
case 'bugreportdev':
      ...
      zee.sendMessage('6285748894171@s.whatsapp.net',`*Bug Report:* ${v}`, text)
      break
...
• Handphone Bot: ${zee.user.phone.device_manufacturer}
...
• Versi Whatsapp : ${zee.user.phone.wa_version}`
      ...
      //Ini SendButinImage klo pake sendButloc kadang ada yg gk respon
        /*  but = [
          ...
          zee.sendMessage(from, { contentText: monospace(menu), footerText: `${wita} || ${tanggal()} | Gak Work Menu nya? Ketik .allmenu`, buttons: [{buttonId: `!allmenu`,buttonText:{displayText: 'MENU'},type:1}],headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: tamnel, contextInfo: {"mentionedJid": [sender]}}}, 'buttonsMessage')
          break
...
Atau Lebih Jelas Hubungi Nomer Owner
wa.me://6285748894171`
...
//»»»𝘉𝘶𝘵𝘵𝘰𝘯 𝘉𝘢𝘮𝘩 
    ...
    case 'group': case 'gc': case 'grup':     	 
          ...
          sendButton(from, menu, 'Created By Nakata', but, troli)
          break           
...
//++Menunya          
    case 'allmenu': case 'm2':          
          ...
          sendButton(from, monospace(allmenu()), 'Created by Nakata', but, troli)
          break         
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            `item3.URL:https://youtube.com/c/NakataZ/\n` +
            `item3.X-ABLabel:⚙️ Channel Owner\n` +
            `item4.ADR:;;🇮🇩 Indonesia;;;;\n` +
            `item4.X-ABADR:ac\n` +
            `item4.X-ABLabel:🌍 Region\n` +
            `item5.X-ABLabel:⚔️ Nah - Botz Owner\n` +
            'END:VCARD'.trim()
zee.sendMessage(from, {displayName: `Creator Nakata`, vcard: vcard3}, contact, 
{ quoted: troli, 
})
break
   ...
   default:
     ...
     /*     if (isCmd) {      
          ...
          sendButton(from, menu, 'Created By Nakata', but, mek)
          break
          }*/
